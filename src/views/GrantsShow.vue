		...
		<div class="pt100 pb50 bg-dark">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-8 mr-auto pb50 ml-auto">
						<h2 class="h1 font300 text-white">
							Use This Section to Enter<span class="text-primary">
								Grant Text.</span
							>
						</h2>
						<p class="lead text-white-gray">
							Choose Grant Text from the library and add it to each section.
							When you have added all of the text you need, hit Finalize Grant
							to view your draft.
						</p>
						<div class="experience-card clearfix">
							<div class="experience-inner">
			...
			<div class="row">
				<div class="col-md-6 offset-md-3 mb-4">
					...
					<h4 class="text-center">
						Funding Organization: {{ grant.funding_org }}
					</h4>
					<h4 class="text-center">
					...
					<!-- Start of sections index/edit sections -->

			<div v-for="section in grant.sections" :key="section.section_id">
				<p >
					{{ section }}
				</p>
				<button v-on:click="showEditSectionMethod(section)">Edit Section</button>
				...
				<div v-if="showEditGrantForm">
					...
					<div class="container my-4">
						<div class="row">
							<form
								class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1"
								v-on:submit.prevent="updateGrant()"
							>
								<h1 class="text-center mb-5">Edit Grant</h1>
								<ul>
									<li class="text-danger" v-for="error in errors">
								...
								<div class="form-group col-md-6">
									Organization
									<select v-model="grant.organization_id">
										<option value="this.grant.organization_id">{{
											this.grant.organization_id
										}}</option>
										<option
								...
								<div class="form-group col-md-6">
									Funding Org
									<select v-model="grant.funding_org_id">
										<option value="this.grant.funding_org_id">{{
											this.grant.funding_org_id
										}}</option>
										<option
											v-bind:value="funding_org.id"
											v-for="funding_org in funding_orgs"
											>{{ funding_org.name }}
										</option>
									</select>
								</div>
						...
						<div class="card-body row">
							<div class="col-md-3 offset-md-1">
								...
								<div>
									<div class="form-group">
										<select class="form-control" v-model="currentBoilerplate">
											<option
												v-for="boilerplate in boilerplates"
												:value="boilerplate"
											>
												{{ boilerplate.text }}
											</option>
								...
								<div>
									<button
										...
										v-on:click="addBoilerplate(currentSection)"
									>
										Add Boilerplate
									</button>
								</div>
							...
							<div class="col-md-8">
								<form v-on:submit.prevent="createSection()">
									<div class="form-group">
										<label>Section Title </label>
										<input class="form-control" type="text" v-model="sectionTitle" />
									</div>
								...
								<!-- <form>
>>>>>>> 615fdf524d368cfd7c5f7fa05d06ba226acc59f2
                <h1>Top Text Box</h1>
  ...
  created: function () {
    axios.get("/api/grants/" + this.$route.params.id).then((response) => {
      response.data.sections.forEach((section) => {
        section.showEditSections = false;
      });
>>>>>>> 615fdf524d368cfd7c5f7fa05d06ba226acc59f2
...
=======
    updateSection: function (section) {
      ...
      axios
        .patch("/api/sections/" + section.section_id + sectionParams)
        .then((response) => {
          console.log(response.data);
          // this.currentSection.changed = false;
        });
