         ...
         <div class="col-md-6 offset-md-3">
          ...
          <div class="row">
            <div class="mx-auto col-md-12">
              <router-link class="btn btn-info m-2" v-bind:to="'/funding-orgs/' + funding_org.id + '/edit'">Edit</router-link>
...
created: function() {
  axios 
    .get("/api/funding-orgs/" + this.$route.params.id)
    .then(response => {
...
methods: {
  destroyFundingOrg: function() {
    axios
      .delete("/api/funding-orgs/" + this.$route.params.id)
      .then(response => {
